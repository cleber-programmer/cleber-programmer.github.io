...
Rex('thumbnailPreview', function (R) {
    return function ({ target: { files: [thumbnail] } }) {
        return __awaiter(this, void 0, void 0, function* () {
            R.sheet('.form_thumbnail:after', ['background-image', `url(${(yield R.crop(thumbnail)).target.result})`]);
        });
    };
});
Rex('thumbnailTemplate', function () {
    return function () {
        return (`
      <input type="file" class="form_thumbnail">
    `);
    };
});
Rex(function (R) {
    let Thumbnail = class Thumbnail {
        render() {
            return R.thumbnailTemplate();
        }
        selectImage(event) {
            R.thumbnailPreview(event);
        }
    };
    __decorate([
        R.atom.attached,
    ...
    ], Thumbnail.prototype, "render", null);
    __decorate([
        R.atom.event('change', '.form_thumbnail'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object]),
        __metadata("design:returntype", void 0)
    ], Thumbnail.prototype, "selectImage", null);
    Thumbnail = __decorate([
        R.atom.component('evnts-thumbnail')
    ], Thumbnail);
});
